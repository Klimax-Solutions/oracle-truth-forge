...
const ORACLE_PROGRESSION = [
  {
    ...
    unlock_condition: "Compte créé et EA actif",
    user_action: "Analyser 15 trades Oracle (checkbox analyse)",
    completion: "questData.ebaucheTradesAnalyzed >= 15",
    validation: "Admin obligatoire (pas d'auto-validation)",
    next_unlock: "Admin valide → Cycle 1 passe en_progress",
    oracle_access: "Aucun (ébauche = analyse pure sans propres trades)",
    notes: "C'est la phase d'initiation. L'utilisateur lit les trades Oracle sans en saisir.",
  },
  {
    step: "Cycle 1 (Phase 1)",
    phase: 1,
    color: "text-primary border-primary/30 bg-primary/5",
    unlock_condition: "Ébauche validée par admin",
    user_action: "Saisir 25 trades (trades 16–40) avec screenshots",
    completion: "user_executions.length >= 25 (total 40)",
    validation: "Auto si précision ≥ 90% | Admin si < 90%",
    next_unlock: "Validation → Cycle 2 in_progress",
    oracle_access: "Oracle Ébauche visible (trades 1-15 d'Oracle)",
    notes: "Premier cycle avec saisie réelle. Règles de temporalité actives.",
  },
  {
