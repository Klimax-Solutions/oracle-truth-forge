  ...
  return (
      <div className="h-full flex flex-col bg-[#0A0B10] overflow-hidden">
        ...
        <div className="flex-1 flex flex-col lg:flex-row overflow-hidden overflow-y-auto lg:overflow-hidden">
          ...
          {/* LEFT — Config (1/3 of screen on desktop, full width stacked on mobile) */}
          <div className="w-full lg:w-1/3 lg:min-w-[400px] shrink-0 border-b lg:border-b-0 lg:border-r border-white/[0.10] flex flex-col lg:overflow-hidden bg-[#0a0a10]">
            {/* Tabs */}
          ...
          {/* RIGHT — Preview (flex-1 desktop, fixed-height stacked on mobile) */}
          <div className="flex-1 flex flex-col lg:overflow-hidden h-[70vh] lg:h-auto">
